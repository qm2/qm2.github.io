...
EUROPE=ROOT/'museum-notes/european-painting'; EUROPE.mkdir(exist_ok=True)
(EUROPE/'index.html').write_text(f'''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>欧洲绘画 · 博物馆札记 | Merton</title><meta name="description" content="Merton在博物馆与教堂见过的欧洲绘画。从卡拉瓦乔开始，沿着画家、题材与收藏故事慢慢整理。"><link rel="stylesheet" href="../museum.css"></head><body><header class="site-header"><a class="signature" href="../">Merton</a><a href="../">博物馆札记 ↗</a></header><main class="wrap notebook-index"><p class="eyebrow">MUSEUM NOTES / EUROPEAN PAINTING</p><h1>欧洲绘画</h1><p class="index-intro">从一位画家开始，<br>把散在不同城市的相遇连起来。</p><section aria-labelledby="europe-start"><p class="eyebrow">FIRST CHAPTER</p><h2 id="europe-start">先看卡拉瓦乔</h2><a class="issue-link" href="../caravaggio/"><img src="../caravaggio/images/caravaggio-470.jpg" alt="卡拉瓦乔《纸牌作弊者》，金贝尔艺术博物馆" width="1707" height="1280"><div><p class="eyebrow">CARAVAGGIO / 1571—1610</p><h2>卡拉瓦乔</h2><p>牌桌、果篮、礼拜堂。再看见那些曾经分开看过的画，以及它们之间的关系。</p><p class="issue-meta">27件作品（含1件归属讨论） · 29张参观照片<br>创作时期 / 收藏故事 / 七组作品比较</p><span class="text-link">进入这一辑 →</span></div></a></section><aside class="notebook-about"><h2>以后慢慢展开</h2><p>这个板块会继续收录在欧洲和美国见到的绘画。可以沿着一位画家读，也可以比较同一个题材在不同年代的样子。</p></aside></main><footer class="site-footer wrap"><a href="../">← 博物馆札记</a><span>摄影 / Merton</span></footer></body></html>''')
print(f'Built European painting, Caravaggio, {len(works)} work pages, and {len(groups)} comparison groups.')
